 ...
 * Table
 */
export default function Table({ headers, data, suffix, nestedGroup, useTokenData, calculateValue }) {
  const TokenData = () => {
    let _tokenArray = [];
    ...
    for (let _token in _Tokens) {
      ...
      if (Object.prototype.hasOwnProperty.call(_Tokens[_token], 'description')) {
