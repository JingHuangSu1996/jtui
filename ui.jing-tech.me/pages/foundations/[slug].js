...
export default function Page({ source, iconData }) {
  return (
    <>
      <NextSeo title={`JTUI - ${source.scope.title} | Foundations`} description={source.scope.description} />
...
export const getStaticProps = async ({ params }) => {
  ...
  if (params.slug === 'icons') {
    const response = await fetch('https://api.figma.com/v1/files/LA6qKUukk8v3YkkuKq6IC6/components', {
