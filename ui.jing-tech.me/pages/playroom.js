...
import { SandpackProvider, SandpackLayout, SandpackCodeEditor, useActiveCode } from '@codesandbox/sandpack-react';
...
export default function Playroom({ source, code: thisCode, hasEditor, isGuide }) {
    ...
    if (hasEditor) {
      return (
        <Kit.Box
          ref={iframeRef}
          as="iframe"
          src={`/playroom?code=${LZString.compressToEncodedURIComponent(firstRenderCode)}`}
          css={{
